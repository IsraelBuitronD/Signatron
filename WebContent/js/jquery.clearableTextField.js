/*
 * Clearable Text Field - jQuery plugin version 0.3.2 Copyright (c) 2009 Tatsuya
 * Ono
 * 
...
(function($) {
	$.fn.clearableTextField = function() {
		if ($(this).length > 0) {
			...
			$(this).each(function() {
				$(this).data('original-padding-right',
	...
	function add_clear_button(input, set_focus) {
		if (input.attr('has_clearable_button') != "1") {
			...
			if (!wrap.hasClass('clear_button_wrapper')) {
				wrap = input
						.wrap('<div class="clear_button_wrapper" style="margin:0;padding:0;position:relative; display:inline;" />');
			}
			...
			input.css('padding-right', parseInt(input
