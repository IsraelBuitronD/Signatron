...
public class repEstadistico extends HttpServlet {
	private static final long serialVersionUID = 1L;
  
	public repEstadistico() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println(" Prueba de query estadistico, para indicar el tiempo  encendido/apagado de un vehiculo ");
		...
		*/
		...
		String urlJSP = "reporteEstadistico.jsp?totalR="+totalR;
